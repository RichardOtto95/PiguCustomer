...
class _ArquivedTablePageState extends State<ArquivedTablePage> {
  ...
  final filedController = Modular.get<OpenTableController>();
  String clickLabel;
  ...
  @override
  void initState() {
    filedController.setClickLabel('onFiled');

    setState(() {
      // filedController.groupEventCounter(homeController.categoryID);
      _filedTablesFuture = getFiledGroup();
      // eventVerifier = filedController.eventVerifier;
      super.initState();
    });
  }
                      ...
                      return snapshot.data != null
                          ? snapshot.data.isEmpty
                              ? EmptyStateList(
                                  ...
                                  title: 'Sem contas arquivadas no momento',
                                  description:
                                      'Não existem contas arquivadas para serem listadas',
                                )
                              : ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    return PersonContainer(
                                      ...
                                      onTap: () {
                                        // //print'ds: $ds');
                                        // filedController.setSellerGroupSelected(
                                        //     ds['seller_id']);

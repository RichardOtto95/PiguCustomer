...
class _PaidTablePageState extends State<PaidTablePage> {
  ...
  final paidController = Modular.get<OpenTableController>();
  String clickLabel;
  ...
  @override
  void initState() {
    paidController.setClickLabel('onPaid');

    setState(() {
      // paidController.groupEventCounter(homeController.categoryID);
      _paidTablesFuture = getPaidGroup();
      // _eventVerifier = paidController.eventVerifier;
      super.initState();
    });
  }
  ...
  Future<dynamic> getPaidGroup() async {
    ...
    mygroup.forEach((element) async {
      ...
      await paidTables.add(_mygroup.data);
    });
                      ...
                      return snapshot.data != null
                          ? snapshot.data.isEmpty
                              ? EmptyStateList(
                                  ...
                                  title: 'Sem contas quitadas no momento',
                                  description:
                                    ...
                                    return Slidable(
                                      ...
                                      secondaryActions: [
                                        InkWell(
                                          onTap: () {
                                            setState(() {
                                              Future<QuerySnapshot> setStatus =
                                                  Firestore.instance
                                                      .collection('users')
                                      ...
                                      child: PersonContainer(
                                        ...
                                        onTap: () {
                                          // //print'ds: $ds');
                                          // paidController.setSellerGroupSelected(
                                          //     ds['seller_id']);
